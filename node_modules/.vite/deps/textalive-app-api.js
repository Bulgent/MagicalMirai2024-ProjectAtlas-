...
function C(t2, e2, r2) {
  return !R.test(t2) && !t2.match(/[（(].+(?:転載|書き起こし).*[）)]/) && (!t2.match(/(作詞|作曲).+(作詞|作曲)/) || 0 !== e2 && e2 !== r2.length - 2);
}
function N(t2) {
            ...
            return n2.sent(), r2 = function(t4) {
              return function(t5) {
                return t5 = function(t6) {
                  ...
                  for (var e3, r3, n3, i2, o2, s2 = new RegExp("[（(]?(.)繰り返し[)）]?", "g"); null !== (r3 = s2.exec(t6)); )
...
function gn() {
  return pn(this, void 0, void 0, function() {
    return hn(this, function(t2) {
      return fn && fn.Player ? [2, fn] : "undefined" == typeof window ? [2, import("./main-EAIRBYOT.js")] : window.Songle && window.Songle.Player ? [2, window.Songle] : [2, new Promise(function(t3) {
        var e2 = false;
    ...
    return pn(this, void 0, void 0, function() {
      ...
      return hn(this, function(i2) {
        switch (i2.label) {
          ...
          case 2:
            return this.manager.isBackgroundSpecialImageAsset(t3) ? [2, { css: 'url("https://api.textalive.jp/images/backgrounds/snowmiku2016/' + (n2 = /^snowmiku2016-([0-9]{2})$/.exec(e2))[1] + '.jpg")', contentUrl: "https://api.textalive.jp/images/backgrounds/snowmiku2016/" + n2[1] + ".jpg", url: "https://snowmiku.com/2016/info_chara.html", name: "SNOW MIKU 2016", authorName: "豆の素", originalUrl: e2, x: t3 ? t3.x : void 0, y: t3 ? t3.y : void 0, defaultY: 0 }] : [2, { originalUrl: null, css: "", x: t3 ? t3.x : void 0, y: t3 ? t3.y : void 0 }];
        }
      });
    });
  ...
  return pn(this, void 0, void 0, function() {
    ...
    return hn(this, function(g2) {
      switch (g2.label) {
        ...
        case 1:
          return g2.trys.push([1, 5, , 6]), (v2 = "undefined" != typeof window && (null === window || void 0 === window ? void 0 : window.WebFont)) ? [3, 3] : [4, import("./webfontloader-6WL2Q34E.js")];
        case 2:
    ...
    return pn(this, void 0, void 0, function() {
      ...
      return hn(this, function(p2) {
        switch (p2.label) {
          ...
          case 1:
            return s2 = p2.sent(), a2 = "ja" === (null == s2 ? void 0 : s2.lang), g.textalive.appToken && (null == s2 ? void 0 : s2.app) && (s2.app.data && (this._name = null === (t3 = s2.app.data) || void 0 === t3 ? void 0 : t3.name, this._author = null === (r2 = null === (e2 = s2.app) || void 0 === e2 ? void 0 : e2.data) || void 0 === r2 ? void 0 : r2.author, u2 = null === (i2 = null === (n2 = s2.app) || void 0 === n2 ? void 0 : n2.data) || void 0 === i2 ? void 0 : i2.status, this._status = "number" == typeof u2 ? u2 : -1), this._server = { version: s2.version, message: s2.app.message, error: s2.app.error }, !this._server.error) ? (l2 = this._server.message ? "\n" + this._server.message : "", a2 ? console.info("[TextAlive API] クライアント v" + g.client.version + " でサーバ v" + (this._server.version || "0.0.0") + " に接続" + l2) : console.info("[TextAlive API] App API client v" + g.client.version + " connected to server v" + (this._server.version || "0.0.0") + l2), this.listener.onAppLoad(this), [2]) : (c2 = (null === (o2 = this._server) || void 0 === o2 ? void 0 : o2.error) ? "\n" + this._server.error : "", a2 ? console.warn("[TextAlive API] このアプリはトークンが正しく指定されていないため動作しません。 https://developer.textalive.jp からトークンを入手して指定してください。" + c2) : console.warn("[TextAlive API] This app requires a valid app token to run properly. You could get a token from https://developer.textalive.jp." + c2), this.listener.onAppLoad(null, c2), [2]);
        }
      });
    });

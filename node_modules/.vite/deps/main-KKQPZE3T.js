      ...
      return function(e) {
        ...
        var h = "songle-api-plugin-songle-widget", y = function(e2) {
          ...
          return c(n2, null, [{ key: "Name", get: function() {
            ...
            if (null == this.player.musicMap || null == this.player.musicMap.chorus)
              return a.default.warn("'Songle.Player' do NOT have a chorus information. Please install the chorus plugin using 'Songle.Plugin.Chorus'"), n3;
            ...
            if (null != e3.width) {
              if (e3.width < 20)
                return a.default.warn("Songle Widget is too small. Please check 'Songle.Plugin.SongleWidget' options"), false;
            ...
            if (null != e3.height) {
              if (this.__showController__ && (e3.height -= this.__controllerHeight__), this.__showOriginalSiteLink__ && (e3.height -= 15), this.__showSongleJpSiteLink__ && (e3.height -= 15), e3.height < 20)
                return a.default.warn("Songle Widget is too small. Please check 'Songle.Plugin.SongleWidget' options"), false;
        ...
        var i = { findPrevBar: function(e2) {
          ...
          for (var i2 = 0; i2 < r2.length; ++i2)
            if (1 == r2[i2].number && n2 > r2[i2].startTime + 500)
              return r2[i2];
          return r2[0];
        }, findNextBar: function(e2) {
          for (var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n2 = null != t2.startTime ? t2.startTime : e2.positionTime, r2 = e2.musicMap.beats || [], i2 = 0; i2 < r2.length; ++i2)
            if (1 == r2[i2].number && n2 < r2[i2].startTime - 500)
              return r2[i2];
          return r2[0];
          ...
          for (var a = 0; a < i2.length; ++a)
            if (n2 > i2[a].startTime + 500)
              return i2[a];
          return i2[0];
        }, findNextRepeatedSectionItem: function(e2) {
          for (var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n2 = null != t2.startTime ? t2.startTime : e2.positionTime, i2 = r(e2, t2), a = 0; a < i2.length; ++a)
            if (n2 < i2[a].startTime - 500)
              return i2[a];
          return i2[0];
        } };
          ...
          return t2 = e2, o2 = [{ key: "Name", get: function() {
            ...
            var t3 = this, n3 = this.player.dispatchers.map(function(n4) {
              return n4 && n4.traps.map(function(n5) {
                if (-1 != t3.__convertToStringArray__(e3).indexOf(n5.name))
                  return n5;
              }).filter(function(e4) {
                return null != e4;
              });
        ...
        var a = [], o = function() {
          ...
          return t2 = e2, o2 = [{ key: "debug", value: function(t3, n3) {
            ...
            switch (e3) {
              ...
              case "warn":
              case "error":
                if (t3 = "[Songle API ".concat(e3, "] ") + t3, -1 != a.indexOf(t3))
                  return;
            }
        ...
        function r(e2, t2) {
          ...
          for (var r2 in t2)
            null != t2[r2] && n2.setAttribute(i(r2), String(t2[r2]));
          return n2;
        }
        function i(e2) {
          switch (e2) {
        ...
        var r = function(e2) {
            ...
            return a2._invoke = /* @__PURE__ */ function(e4, t4, n4) {
              ...
              return function(i3, a3) {
                ...
                for (n4.method = i3, n4.arg = a3; ; ) {
                  ...
                  var s2 = l(e4, t4, n4);
                  if ("normal" === s2.type) {
                    if (r4 = n4.done ? "completed" : "suspendedYield", s2.arg === c)
                      continue;
          ...
          function b(e3, t3) {
            ...
            if ("throw" === r3.type)
              return t3.method = "throw", t3.arg = r3.arg, t3.delegate = null, c;
            var i2 = r3.arg;
          ...
          return _.prototype = v.constructor = p, p.constructor = _, _.displayName = u(p, o, "GeneratorFunction"), e2.isGeneratorFunction = function(e3) {
            ...
            if (this.prev = 0, this.next = 0, this.sent = this._sent = void 0, this.done = false, this.delegate = null, this.method = "next", this.arg = void 0, this.tryEntries.forEach(T), !e3)
              for (var t3 in this)
            ...
            for (var t3 = this.tryEntries.length - 1; t3 >= 0; --t3) {
              ...
              if (n3.finallyLoc === e3)
                return this.complete(n3.completion, n3.afterLoc), T(n3), c;
            }
          }, catch: function(e3) {
            for (var t3 = this.tryEntries.length - 1; t3 >= 0; --t3) {
              var n3 = this.tryEntries[t3];
        ...
        var C = function(e2) {
          ...
          return k(a2, null, [{ key: "Name", get: function() {
            ...
            if (null != t3 && e3 >= t3.relativeStartTime && e3 < t3.relativeEndTime)
              return t3;
            ...
            if (null == e3)
              return 0;
            if (this.localAbsoluteClockTime - this.stageAbsoluteStartTime < 0)
              return 0;
            var t3 = this.__getPlaylistPositionTime__();
            if (this.stageIsPlaying) {
              if (t3 >= e3.mediaStartTime && t3 < e3.mediaStartTime + e3.mediaDurationTime)
                return 1;
            } else if (this.stageIsPaused && t3 >= e3.mediaStartTime && t3 < e3.mediaStartTime + e3.mediaDurationTime)
              return 2;
            return 0;
            ...
            if (!this.isSlave)
              return y.MessageAPI.updateMessage(this, e3);
          } }, { key: "__play__", value: function() {
        ...
        var d = { create: function(e2, t2) {
          ...
          return new Promise(function(i2, a2) {
            if (n2.headless) {
              ...
              if (null != n2.altSourceUrl)
                v = new RegExp("www.youtube.com").test(n2.altSourceUrl) ? "www.youtube.com" : "";
              switch (v) {
        ...
        var o = { importClass: function() {
          ...
          return new Promise(function(t2, n2) {
            if (i.default.NnFactoryClass)
              return t2(i.default.NnFactoryClass);
        ...
        var o = { importClass: function() {
          var e2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          return new Promise(function(t2, n2) {
            if (i.default.YtFactoryClass)
              return t2(i.default.YtFactoryClass);
            var o2 = e2.element || i.default.global.document.body;
        ...
        var f = function(e2) {
          ...
          return t2 = c2, (n2 = [{ key: "resetState", value: function() {
            ...
            if (this.player.media.isPaused)
              return this.__stopNumberOfTrails__ = 0, void (this.__stopNumberOfTrailsThreshold__ = 0);
            ...
            if (this.player.media.isPlaying)
              return this.__playNumberOfTrails__ = 0, void (this.__playNumberOfTrailsThreshold__ = 0);
            ...
            if (this.player.media.isPaused)
              return this.__pauseNumberOfTrails__ = 0, void (this.__pauseNumberOfTrailsThreshold__ = 0);
                  ...
                  if (this.offsetTime < this.negativeOffsetTimeThreshold) {
                    switch (this.player.media.dispatcherName) {
                      case i.default.Name:
                        ...
                        break;
                      default:
                        if (!this.player.media.isReady)
                          return;
                        if (Math.abs(this.offsetTime) < 1e3)
                          return void this.__suspendStateWorker__();
                        this.player.media.seekTo(e3);
                    }
                    ...
                    if (this.__incrementSyncedCount__(), this.syncedCount % this.syncedCountThreshold != 0)
                      return;
        ...
        e.exports = function(e2, t2, n2) {
          ...
          if (o[6] = 15 & o[6] | 64, o[8] = 63 & o[8] | 128, t2)
            for (var u = 0; u < 16; ++u)
              t2[a + u] = o[u];
          return t2 || i(o);
        };
        ...
        var o = { importClass: function() {
          return new Promise(function(e2, t2) {
            if (i.default.ScFactoryClass)
              return e2(i.default.ScFactoryClass);
        ...
        if (n) {
          ...
          e.exports = function() {
            for (var e2, t2 = 0; t2 < 16; t2++)
              0 === (3 & t2) && (e2 = 4294967296 * Math.random()), i[t2] = e2 >>> ((3 & t2) << 3) & 255;
            return i;
          };
        }
      }, 96: function(e, t) {
...
songle-api/lib/main.js:
   ...
   *)
*/
//# sourceMappingURL=main-KKQPZE3T.js.map
